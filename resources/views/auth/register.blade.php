...
<body>
<div class="container mt-5 rounded-lg shadow d-flex align-items-center justify-content-center">
            <div class="row ">
                <div class="col-md-6">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="col-md-7 offset-md-6 mt-2"> 
                            <p>Do you have an account ? <a class="text-primary" href="#" >Login</a></p>
                        </div>                         
                    </form> 
                </div>
            </div>
